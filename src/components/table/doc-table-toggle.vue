...
export default {
  ...
  data() {
    return {
      headers: [
        {prop: 'name', label: 'Name', style: {height: '40px', width: '200px'}},
        {prop: 'gender', label: 'Gender', style: {height: '40px', width: '120px'}},
        {prop: 'age', label: 'Age', style: {height: '40px', width: '120px'}},
